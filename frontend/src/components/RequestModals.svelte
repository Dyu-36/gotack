<script lang="ts">
  import type { PermissionRequestPayload, QuestionRequestEvent } from '../platform/desktop'
  ...
  let { permission, question, onPermission, onQuestion, secondsLeft = 0, expired = false }: Props = $props()
