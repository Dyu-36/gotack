...
| internal/ | Desktop-side implementation, one package per role: appconfig, attachments, changes, contextseed, crushapi, engine, logging, mcp, office, officecli, permission, session, terminal, uievents, workspace, zalo |
