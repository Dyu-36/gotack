...
| internal/ | Desktop-side implementation, one package per role: appconfig, attachments, changes, crushapi, engine, logging, mcp, office, officecli, permission, recall, session, terminal, uievents, workspace, zalo |
